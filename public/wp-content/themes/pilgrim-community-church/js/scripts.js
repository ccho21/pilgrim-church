...
$(document).ready((function () {
    ...
    let onePageScroll = $('#one-page-scroll');

    if ($('section').is('#main__page')) {
        ...
        // onePageScroll.removeClass('onepage-wrapper');
    }
    ...
    $(window).resize(function () {
        ...
        else if (width < 768 && $(window).width() > 768) {
            location.reload();
        }
    });
    $('.mobile__page-scroll__up').on('click', () => $(".main").moveUp());
    $('.mobile__page-scroll__down').on('click', () => $(".main").moveDown());
